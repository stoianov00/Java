...
public class Pizza {
    private static final String INVALID_PIZZA_NAME_EXCEPTION = "Pizza name should be between 1 and 15 symbols.";
    private static final String INVALID_COUNT_OF_TOPPINGS_EXCEPTION = "Number of toppings should be in range [0..10].";
